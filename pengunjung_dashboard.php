...
if (isset($_GET['id_mitra'])) {
    ...
    $_SESSION['id_mitra_pilihan'] = $id_mitra; 
} 
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom shadow-sm mb-4">
    <div class="container">
        <a class="navbar-brand fw-bold" href="index.php"><i class="fas fa-futbol me-2"></i> PLAYGROUND</a>
...
<div class="container mb-5">
    <div class="row">
        <div class="col-lg-7">
            ...
            <h5 class="fw-bold mb-3">Fasilitas Cabang</h5>
            <div class="row g-3">
                <?php 
                ...
                if(mysqli_num_rows($q) > 0):
                    while($f = mysqli_fetch_array($q)):
                        $is_renovasi = ($f['status_lapangan'] == 'Renovasi');
                ?>
                <div class="col-md-6">
                    <div class="card card-facility shadow-sm h-100 position-relative">
                        ...
                        <div class="img-wrapper">
                            ...
                            <?php if($is_renovasi): ?>
                                <div class="overlay-renovasi">
                                    <span class="badge bg-danger px-3 py-2"><i class="fas fa-tools me-2"></i>RENOVASI</span>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <p class="text-danger small mb-0"><i class="fas fa-exclamation-triangle me-1"></i> Maaf, sedang tidak tersedia</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="proses_booking.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="id_fasilitas" class="form-select bg-light border-0 py-2" required>
                                ...
                                <?php 
                                // PERBAIKAN: Hanya tampilkan fasilitas yang statusnya 'Tersedia'
                                $q2 = mysqli_query($conn, "SELECT * FROM fasilitas WHERE id_mitra = '$id_mitra_aktif' AND status_lapangan = 'Tersedia'");
                            ...
                            <?php if(mysqli_num_rows($q2) == 0): ?>
                                <small class="text-danger mt-1 d-block font-italic">*Maaf, semua lapangan sedang tidak tersedia.</small>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="p-3 rounded-3 mb-4" style="background-color: #f8f9fa; border: 1px dashed #dee2e6;">
                            ...
                            <p class="small mb-0 text-muted">Anda memesan untuk mitra <strong><?= $mitra['nama_mitra']; ?></strong>.</p>
                        </div>
                        
                        <button type="submit" name="submit_booking" class="btn btn-primary w-100 py-3 fw-bold rounded-3 shadow-sm" 
                                <?php if(mysqli_num_rows($q2) == 0) echo 'disabled'; ?>>
